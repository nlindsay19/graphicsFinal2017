...
GLuint CubeLoader::createShaderProgram(const char *vertexFilePath,const char *fragmentFilePath)
{
...
GLuint CubeLoader::createShader(GLenum shaderType, const char *filepath)
{
...
void CubeLoader::initializeGlew()
{
